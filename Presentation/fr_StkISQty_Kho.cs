...
{
    public partial class fr_StkISQty_Kho : Form
    {

        public fr_StkISQty_Kho()
        {
            InitializeComponent();
        ...
        private void Exit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                fr_StkISQty_Kho f3 = (fr_StkISQty_Kho)Application.OpenForms["fr_StkISQty_Kho"];
                f3.Close();
            }
        ...
        void fr_StkISQty_Shown(object sender, EventArgs e)
        {
        ...
        void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            string sql1 = "rpt_StkISQty_Kho";
            //dt = cn.taobang_from_Procedure(sql);
            //List_Connected.DataSource = cn.taobang_from_Procedure(sql1);
            table1 = cn.taobang_from_Procedure_Ton_Kho_Now(sql1, frdate, todate, Node_Id.Text.ToString(), 3);
        ...
        private void setDataSource(DataTable table)
        {
            ...
            else
            {
                ...
                {
                    if (dataGridView_full.Columns[i].Name.Contains("ton") || dataGridView_full.Columns[i].Name.Contains("_2_") || dataGridView_full.Columns[i].Name.Contains("_3_") || dataGridView_full.Columns[i].Name.Contains("_4_"))
                    {
                        dataGridView_full.Columns[i].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                        dataGridView_full.Columns[i].DefaultCellStyle.Format = "#,##";  //"N2";
                    }
                }
                //for (int i = 0; i < dataGridView_full.Rows.Count; i++)
                //{
        ...
        private void fr_StkISQty_Load(object sender, EventArgs e)
        {
        ...
        private void Exprot_Table2Excl()
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                wb.Worksheets.Add(table1, "Tồn_Kho");
                ...
                string Filename = "D:\\Ton_kho_" + DateTime.Today.Day + DateTime.Today.Month + DateTime.Today.Year + "_" + n + ".xlsx";
        ...
        private void New_Export_Click1()
        {
            ...
            SaveFileDialog sfd = new SaveFileDialog();
            sfd.Filter = "Excel Documents (*.xls)|*.xls";
            sfd.FileName = "Inventory_Export.xlsx";
            if (sfd.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    workSheet.Cells[1, 4] = "Thời gian : " + frdate.Value.ToString("dd/M/yyyy");
                    //int next = 0;
                    //for (int i = 1; i <= cot; i++)
                    //{
                    //    try
