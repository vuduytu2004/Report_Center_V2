...
{
    public partial class rpt_StkISQty_Order : Form
    {

        public rpt_StkISQty_Order()
        {
            InitializeComponent();
            //Shown += new EventHandler(rpt_StkISQty_Order_Shown);
        ...
        private void Exit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                rpt_StkISQty_Order f3 = (rpt_StkISQty_Order)Application.OpenForms["rpt_StkISQty_Order"];
                f3.Close();
            }
        ...
        void rpt_StkISQty_Order_Shown(object sender, EventArgs e)
        {
        ...
        void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            string sql1 = "rpt_StkISQty_Order";
        ...
        private void rpt_StkISQty_Order_Load(object sender, EventArgs e)
        {
        ...
        private void Exp2Excl_Click(object sender, EventArgs e)
        {
            ...
            sfd.FileName = "STK_Qty_On_Order.xls";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            /// -----------------------------test//----------------------------------------------------------------------------------
            string sql2 = @"Select * from NHAP_ORDER with(nolock) ";
            //dt = cn.taobang_from_Procedure(sql);
            //List_Connected.DataSource = cn.taobang_from_Procedure(sql1);
            //table = cn.taobang_from_Procedure(sql1);
            table3 = cn.taobang(sql2);
            setDataSource_DataTable1(table3, dataGridView_full);
        }
        ...
        private void New_Export_Click1()
        {
            ...
            SaveFileDialog sfd = new SaveFileDialog();
            sfd.Filter = "Excel Documents (*.xls)|*.xls";
            sfd.FileName = "STK_Qty_On_Order.xlsx";
            if (sfd.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    for (int i = 1; i <= cot; i++)
                    {
                        try
                        {
                            ...
                            if (name.Contains("_3_"))
                            {
                                ...
                                workSheet.Cells[1, i - 2] = name.Substring(15);
        ...
        private void New_Export_Click2()
        {
            ...
            if (sfd.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    try
                    {
                        //curWorkBook = app.Workbooks.Open(Filename, defaultArg, defaultArg, defaultArg, defaultArg, defaultArg, defaultArg, defaultArg, defaultArg, defaultArg, defaultArg, defaultArg, defaultArg, defaultArg, defaultArg);
                        ...
                        //workSheet.Cells[1, 5] = "Thời gian : " + frdate.Value.ToString("dd/M/yyyy") + " - " + todate.Value.ToString("dd/M/yyyy");
                        ...
                        for (int i = 1; i <= cot; i++)
                        {
                            try
                            {
                                ...
                                if (name.Contains("_3_"))
                                {
                                    // Do Something // 
                                    workSheet.Columns[i].font.Color = XlRgbColor.rgbRed;
                                    workSheet.Cells[1, i - 2] = name.Substring(16);
                                    workSheet.Range[workSheet.Cells[1, i - 2], workSheet.Cells[1, i]].Merge();
                                    if (next == 0)
                                    {
                                        workSheet.Range[workSheet.Cells[2, i - 2], workSheet.Cells[2, i]].Interior.Color = XlRgbColor.rgbPeachPuff;
