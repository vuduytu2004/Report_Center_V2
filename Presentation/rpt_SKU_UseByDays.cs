...
{
    public partial class rpt_Sku_UseByDays : Form
    {

        public rpt_Sku_UseByDays()
        {
            InitializeComponent();
            //Shown += new EventHandler(rpt_Sku_UseByDays_Shown);
            ...
            //Node_Id.Text = "";
            //cn.Load_TextBox(Node_Id, @"SELECT  (a.NODE_ID)  from stock   a
            //                inner join node_def as b on a.stk_id=b.stk_id
        ...
        private void Exit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                rpt_Sku_UseByDays f3 = (rpt_Sku_UseByDays)Application.OpenForms["rpt_Sku_UseByDays"];
                f3.Close();
            }
        ...
        void rpt_Sku_UseByDays_Shown(object sender, EventArgs e)
        {
        ...
        void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            //            left join dsmart12.dbo.goods  as c with(nolock) on a.sku_id='29'+c.goods_id+'0000'
            //            where plu_code<>'' and a.status in ('01','03')
            //            UNION 
            //            select a.sku_id,a.sku_code,a.plu_code,a.dept_id,a.grp_id,(grp_name),(full_name),a.unit_symb,rtprice,tax_rate,a.status,a.ITEM_TYPE as 'Loại hàng', c.usebydays as 'Số ngày SD' from dsmart12.dbo.sku_def a with(nolock) --as b on a.sku_id=b.sku_id
            //            left join dsmart12.dbo.goods  as c with(nolock) on a.sku_id='29'+c.goods_id+'0000'
            //            where  plu_code='' and c.usebydays<>0 and a.status in ('01','03')
            //            order by grp_id,sku_id";

            table1 = cn.taobang1(sql);
            //dataGridView_full.DataSource = cn.taobang1(sql);
            ////////////////////string sql1 = "rpt_StkISQty_Order_CoreMart";
            //////////////////////dt = cn.taobang_from_Procedure(sql);
            //////////////////////List_Connected.DataSource = cn.taobang_from_Procedure(sql1);
            ////////////////////table_set1 = cn.taobang_from_Procedure_Parameter5(sql1, frdate, todate, Node_Id.Text.ToString(), core);
        ...
        private void rpt_Sku_UseByDays_Load(object sender, EventArgs e)
        {
        ...
        //        Node_Id.Text = "";
        //    cn.Load_TextBox(Node_Id, @"SELECT  (a.NODE_ID)   from dbo.stock   a
        //                      inner join node_def as b on a.stk_id=b.stk_id
        ...
        {
            //if (table_set1.Tables[0].Rows.Count==0)
            //{ return; }
            //if ((dataGridView_full.DataSource as DataTable).Rows.Count == 0)
            //{ return; }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            /// -----------------------------test//----------------------------------------------------------------------------------
            string sql1 = @"Select * from BRG_Info";
            //dt = cn.taobang_from_Procedure(sql);
            //List_Connected.DataSource = cn.taobang_from_Procedure(sql1);
            ...
            ///// -----------------------------test//----------------------------------------------------------------------------------
            //string sql2 = @"Select * from NHAP_ORDER_SUM";
            ////dt = cn.taobang_from_Procedure(sql);
            ////List_Connected.DataSource = cn.taobang_from_Procedure(sql1);
            ////table = cn.taobang_from_Procedure(sql1);
        ...
        private void New_Export_Click1()
        {
            ...
            SaveFileDialog sfd = new SaveFileDialog();
            sfd.Filter = "Excel Documents (*.xls)|*.xls";
            sfd.FileName = "SKU USE BY DAYS.xlsx";
            if (sfd.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    //    workSheet.Activate();
                    workSheet.Name = "USEBYDAYS";
                    workSheet.Rows[1].WrapText = true;
                    workSheet.Range["B:F"].NumberFormat = "0";
                    ...
                    Excel.Range newRng1 = workSheet.Range[workSheet.Cells[1, "A"], workSheet.Cells[1, cot]];
                    newRng1.Font.Size = 9;
        ...
        //                //workSheet.Cells[1, 5] = "Mart-Core" + excl_core + "- Thời gian : " + frdate.Value.ToString("dd/M/yyyy") + " - " + todate.Value.ToString("dd/M/yyyy");
        ...
        private void core1_CheckedChanged(object sender, EventArgs e)
        {
