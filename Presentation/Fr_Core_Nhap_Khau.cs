...
{
    public partial class Fr_Core_Nhap_Khau : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string file_temp = "Template-Core_Nhap_Khau.xlsx";
        ...
        private void import_data_Click_luu(object sender, EventArgs e)
        {
            ...
            using (var package = new ExcelPackage(new FileInfo(filePath)))
            {
                ...
                {
                    string rpt_key = ws.Cells[row, 1].Text.Trim();
                    ...
                    dt.Rows.Add(rpt_key, sku_id,  DateTime.Now);
                }
                ...
                using (SqlConnection conn = new SqlConnection(bientoancuc.connectionString))
                {
                    ...
                    using (SqlTransaction tran = conn.BeginTransaction())
                    {
                        try
                        {
                            ...
                            string sqlUpdate = @"UPDATE Core_Nhap_Khau 
                            ...
                            {
                                bulk.DestinationTableName = "Core_Nhap_Khau";
        ...
        private void exp_target_BRG_Click(object sender, EventArgs e)
        {
            ...
            string fileTemp = "Template-Core_Nhap_Khau";
                ...
                if (saveFileDialog.ShowDialog() == DialogResult.OK)
                {
                    try
                    {
                        ...
                        using (SqlConnection connection = new SqlConnection(bientoancuc.connectionString))
                        {
                            ...
                            string sqlQuery = @"SELECT Rpt_key,SKU_ID FROM [Core_Nhap_Khau] WHERE status=1 ORDER BY rpt_key,SKU_ID";
