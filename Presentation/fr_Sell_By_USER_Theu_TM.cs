...
{
    public partial class fr_Sell_By_USER_Theu_TM : Form
    {

        public fr_Sell_By_USER_Theu_TM()
        {
            InitializeComponent();
            ...
            frdate.MaxDate = DateTime.Today.AddDays(-1);
            todate.MaxDate = DateTime.Today.AddDays(-1);
            frdate.MinDate = new DateTime(2018, 12, 1);
        ...
        private void Exit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                fr_Sell_By_USER_Theu_TM f3 = (fr_Sell_By_USER_Theu_TM)Application.OpenForms["fr_Sell_By_USER_Theu_TM"];
                f3.Close();
            }
        ...
        void fr_Sell_By_USER_Theu_TM_Shown(object sender, EventArgs e)
        {
        ...
        void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            string sql1 = "rpt_Sell_By_USER_Theu_TM";
            //dt = cn.taobang_from_Procedure(sql);
            //List_Connected.DataSource = cn.taobang_from_Procedure(sql1);
            table1 = cn.taobang_from_Procedure_Parameter1_Center_USER(sql1, frdate, todate, Node_Id.Text.ToString(), 3);
        ...
        private void fr_Sell_By_USER_Theu_TM_Load(object sender, EventArgs e)
        {
        ...
        private void tk_Full_Click(object sender, EventArgs e)
        {
            ...
            string sql1 = @"select COUNT(DISTINCT right(left(stk_id,4),3))  from DATA_DETAIL.dbo.STOCK  with(nolock)  where right(left(stk_id,4),3) in (" + dk + ")";
            i = cn.Gan_max_progressbar_Center(sql1);
            if (i == 0)
            {
                MessageBox.Show("Điều kiện Siêu Thị/Vùng.." + dk + " không có." + "\n" + "Hãy kiểm tra lại .", "Chú ý !", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            //}
            ClearTable(table1);
        ...
        private void Exprot_Table2Excl()
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                wb.Worksheets.Add(table1, "DT-Bill");
                ...
                string Filename = "D:\\DT-Bill_" + DateTime.Today.Day + DateTime.Today.Month + DateTime.Today.Year + "_" + n + ".xlsx";
        ...
        private void btm_Fillter_Click(object sender, EventArgs e)
        {
            if ((dataGridView_full.DataSource as DataTable) != null)
            {
                ...
                {
                    (dataGridView_full.DataSource as DataTable).DefaultView.RowFilter = string.Format("stk_id LIKE '%'", txt_Fillter.Text);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            SaveFileDialog sfd = new SaveFileDialog();
            sfd.Filter = "Excel Documents (*.xls)|*.xls";
            sfd.FileName = "Bill_LE_Buon.xlsx";
            if (sfd.ShowDialog() == DialogResult.OK)
            {
                try
                {
        ...
        private void New_Export_Click1()
        {
            ...
            SaveFileDialog sfd = new SaveFileDialog();
            sfd.Filter = "Excel Documents (*.xls)|*.xls";
            sfd.FileName = "Báo cáo Doanh thu chi tiết bán theo NV Thu Ngân.xlsx";
            if (sfd.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    workSheet.Range[workSheet.Cells[3, "A"], workSheet.Cells[dong, cot]].AutoFormat(XlRangeAutoFormat.xlRangeAutoFormatList3);
                    //workSheet.Range[workSheet.Cells[1, "A"], workSheet.Cells[1, cot]].Borders.LineStyle = XlLineStyle.xlContinuous;
                    workSheet.Range[workSheet.Cells[3, "A"], workSheet.Cells[dong, cot]].font.size = 10;



                    Excel.Range newRng = workSheet.Range[workSheet.Cells[3, "A"], workSheet.Cells[3, cot]];
                    ...
                    workSheet.Range[workSheet.Cells[3, "A"], workSheet.Cells[dong + 2, cot]].Borders.LineStyle = XlLineStyle.xlContinuous;

                    Excel.Range newRng1 = workSheet.Range[workSheet.Cells[1, "A"], workSheet.Cells[2, cot]];
                    newRng1.Font.Size = 12;
                    newRng1.RowHeight = 24;
                    newRng1.VerticalAlignment = XlVAlign.xlVAlignCenter;
                    newRng1.HorizontalAlignment = XlHAlign.xlHAlignCenter;

                    workSheet.Cells[1, 4] = "BÁO CÁO DOANH THU CHI TIẾT BÁN THEO NHÂN VIÊN THU NGÂN TỪNG ĐIỂM";
