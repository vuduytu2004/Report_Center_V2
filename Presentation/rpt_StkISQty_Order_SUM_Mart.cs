...
{
    public partial class rpt_StkISQty_Order_SUM_Mart : Form
    {

        public rpt_StkISQty_Order_SUM_Mart()
        {
            InitializeComponent();
            //Shown += new EventHandler(rpt_StkISQty_Order_SUM_Mart_Shown);
        ...
        private void Exit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                rpt_StkISQty_Order_SUM_Mart f3 = (rpt_StkISQty_Order_SUM_Mart)Application.OpenForms["rpt_StkISQty_Order_SUM_Mart"];
                f3.Close();
            }
        ...
        void rpt_StkISQty_Order_SUM_Mart_Shown(object sender, EventArgs e)
        {
        ...
        private void rpt_StkISQty_Order_SUM_Mart_Load(object sender, EventArgs e)
        {
        ...
        private void tk_Full_Click(object sender, EventArgs e)
        {
            ...
            if (core1.Checked == true)
            { core = "1"; excl_core = " 1 "; }
            else
            { core = "2"; excl_core = " 1+2 "; }
        ...
        private void New_Export_Click1()
        {
            ...
            SaveFileDialog sfd = new SaveFileDialog();
            sfd.Filter = "Excel Documents (*.xls)|*.xls";
            sfd.FileName = "STK_Qty_On_Order_Mart_Sum.xlsx";
            if (sfd.ShowDialog() == DialogResult.OK)
            {
                try
                {
        ...
        private void dataGridView_recap_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
